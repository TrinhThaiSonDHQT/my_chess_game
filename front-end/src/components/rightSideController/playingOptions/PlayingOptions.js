import styles from './PlayingOptions.module.scss';

function PlayingOptions() {
  return (
    <>
      <div className={styles.playingOptions}>
        <div className={styles.playingOptionsHeader}>
          <h1>Play Chess</h1>
        ...
        <div className={styles.playingOptionsButtons}>
          <a className={styles.buttonGroup} href="/play/online">
          ...
          <a className={styles.buttonGroup} href="/play/computer">
            <div className={styles.buttonGroupText}>
              <h2>Computer</h2>
          ...
          <a className={styles.buttonGroup} href="/play/friend">
            <div className={styles.buttonGroupText}>
              <h2>Play a Friend</h2>
